...
const en = {
    ...
    "filemenu.copyEntry": "Copy File/Folder",
    "filemenu.pasteEntry": "Paste",
    ...
    // Port forwards (remote terminal management)
    "term.portForwards.openTitle": "Manage port forwards",
    "term.portForwards.title": "Port Forwards",
    "term.portForwards.refresh": "Refresh",
    "term.portForwards.loading": "Loading port forwards...",
    "term.portForwards.empty": "No port forwards configured.",
    "term.portForwards.create": "Create",
    "term.portForwards.delete": "Delete",
    "term.portForwards.openBrowser": "Open",
    "term.portForwards.localPort": "Local Port",
    "term.portForwards.remoteHost": "Remote Host",
    "term.portForwards.remotePort": "Remote Port",
    "term.portForwards.autoRestore": "Auto-restore after reconnect",
    "term.portForwards.columns.local": "Local Endpoint",
    "term.portForwards.columns.remote": "Remote Endpoint",
    "term.portForwards.columns.restore": "Auto",
    "term.portForwards.columns.status": "Status",
    "term.portForwards.columns.actions": "Actions",
    "term.portForwards.enabled": "On",
    "term.portForwards.disabled": "Off",
    "term.portForwards.status.running": "Running",
    "term.portForwards.status.stopped": "Stopped",
    "term.portForwards.status.error": "Error",
    "term.portForwards.status.unknown": "Unknown",
    "term.portForwards.confirm.delete": "Delete forward {local} -> {remote}?",
    "term.portForwards.errors.localUnsupported": "Port forwarding is only available for remote SSH connections.",
    "term.portForwards.errors.wslUnsupported": "Port forwarding for WSL connections is not supported yet.",
    "term.portForwards.errors.awsUnsupported": "Port forwarding for AWS profile connections is not supported.",
    "term.portForwards.errors.invalidPort": "Please enter valid local and remote ports (1-65535).",
...
const zhCN: Record<I18nKey, string> = {
    ...
    "filemenu.rename": "重命名",
    "filemenu.copyEntry": "复制文件/文件夹",
    "filemenu.pasteEntry": "粘贴",
    ...
    // Port forwards (remote terminal management)
    "term.portForwards.openTitle": "管理端口转发",
    "term.portForwards.title": "端口转发",
    "term.portForwards.refresh": "刷新",
    "term.portForwards.loading": "正在加载端口转发...",
    "term.portForwards.empty": "暂无端口转发。",
    "term.portForwards.create": "创建",
    "term.portForwards.delete": "删除",
    "term.portForwards.openBrowser": "打开",
    "term.portForwards.localPort": "本地端口",
    "term.portForwards.remoteHost": "远程主机",
    "term.portForwards.remotePort": "远程端口",
    "term.portForwards.autoRestore": "重连后自动恢复",
    "term.portForwards.columns.local": "本地端点",
    "term.portForwards.columns.remote": "远程端点",
    "term.portForwards.columns.restore": "自动",
    "term.portForwards.columns.status": "状态",
    "term.portForwards.columns.actions": "操作",
    "term.portForwards.enabled": "开",
    "term.portForwards.disabled": "关",
    "term.portForwards.status.running": "运行中",
    "term.portForwards.status.stopped": "已停止",
    "term.portForwards.status.error": "错误",
    "term.portForwards.status.unknown": "未知",
    "term.portForwards.confirm.delete": "确定删除转发 {local} -> {remote}？",
    "term.portForwards.errors.localUnsupported": "端口转发仅支持远程 SSH 连接。",
    "term.portForwards.errors.wslUnsupported": "暂不支持 WSL 连接的端口转发。",
    "term.portForwards.errors.awsUnsupported": "不支持 AWS 配置连接的端口转发。",
    "term.portForwards.errors.invalidPort": "请输入有效的本地和远程端口（1-65535）。",
