...
| <Kbd k="Alt:ArrowUp" mac="N/A"/>              | Switch to previous terminal session in the current multi-session terminal block |
| <Kbd k="Alt:ArrowDown" mac="N/A"/>            | Switch to next terminal session in the current multi-session terminal block     |
